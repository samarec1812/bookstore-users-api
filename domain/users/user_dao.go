...
import (
	"fmt"
	"github.com/samarec1812/bookstore-users-api/datasources/mysql/users_db"
...
func (user *User) FindByStatus(status string) ([]User, *errors.RestErr) {
	...
	for rows.Next() {
		var userItem User
		if err := rows.Scan(&userItem.Id, &userItem.FirstName, &userItem.LastName, &userItem.Email, &userItem.DateCreated, &userItem.Status); err != nil {
